<?php
    ...
    {
        $idLigaForm = $_POST['idLiga'];
        $newPassword = md5($_POST['password']);
        $query = "UPDATE usuarios SET password='$newPassword' WHERE id_liga='$idLigaForm'";
        echo $query;
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-title">
                                    <div class="caption font-green-haze">
                                        ...
                                        <span class="caption-subject bold uppercase"> Cambiar password Liga </span>
                                    </div>
                                </div>
                                <?php 
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form role="form" class="form-horizontal" action="password-liga.php" method="POST" enctype="multipart/form-data">
                                    <input type="hidden" name="idLiga" value="<?php echo $idLiga; ?>"></input>
                                        <div class="form-body">
